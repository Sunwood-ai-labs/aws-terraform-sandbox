...
**aws-terraform-sandbox** is an experimental platform for automating and managing AWS cloud infrastructure using Terraform. This repository aims to provide a sandbox environment for everyone, from beginners to advanced users, to experiment and learn about building cloud infrastructure.

We offer various Terraform templates and scripts to safely experiment with real AWS environments.
...
- 🎉 v1.0.0 Release 🎉  ![v1.0.0](https://github.com/Sunwood-ai-labs/aws-terraform-sandbox/releases/tag/v1.0.0)
