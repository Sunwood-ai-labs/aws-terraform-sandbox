...
def create_release_headers(tag: str, output_dir: str, font_name: str):
    ...
    image_service.generate_header_image(tag, tagged_output_path, font_name, target_ratio=0.5)
    ...
    image_service.generate_header_image(tag, latest_output_path, font_name, target_ratio=0.5)
